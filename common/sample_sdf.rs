...
impl<'a> SampleDistance<'a> {
    pub fn from_common_with_sdf(common: &'a Common, sdf_name: &str) -> Self {
        use wgpu::*;

        // Shader module
        let sdf_path = format!("shaders/sdf/{}.wgsl", sdf_name);
        let module = common.load_wgsl_with_sdf(sdf_path.as_str(), "shaders/sample_sdf.wgsl");
        ...
        let pipeline =
            self.common
                ...
                .create_compute_pipeline(&wgpu::ComputePipelineDescriptor {
                    ...
                    module: &self.module,
                    entry_point: Some("kernel_sample_distance"),
